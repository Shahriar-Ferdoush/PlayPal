...
public class Controller implements Initializable {
    ...
    @FXML
    private ChoiceBox speedChoiceBox;
    ...
    private void setSpeedChoiceBoxAction(){
        ...
        String value = (String) speedChoiceBox.getValue();
    ...
    @FXML
    public void handleOpenButtonAction(javafx.event.ActionEvent actionEvent) {
    ...
    @FXML
    private void handleFullScreenIconAction(MouseEvent event) {  }
    ...
    public void handleLoopButtonAction(ActionEvent actionEvent) {
        if(mediaPlayer != null) {
            if (mediaPlayer.getCycleCount() != MediaPlayer.INDEFINITE) {
                ...
                buttonLoop.setStyle("-fx-background-color: #212121");
            } else {
    ...
    public void handleFacebookLink(MouseEvent event) throws IOException {
        String URL = ("https://www.facebook.com/shahriar.ferdoush.5");
        Desktop.getDesktop().browse(URI.create(URL));
    }

    public void handleGmailLink(ActionEvent actionEvent) throws IOException {
        String URL = ("https://mail.google.com/mail/?view=cm&fs=1&to=shahriar.ss1212@gmail.com");
        Desktop.getDesktop().browse(URI.create(URL));
    }

    public void handleUniversityMailLink(ActionEvent actionEvent) throws IOException{
        String URL = ("https://mail.google.com/mail/?view=cm&fs=1&to=1805101@ugrad.cse.buet.ac.bd");
        Desktop.getDesktop().browse(URI.create(URL));
    }

    public void handleGitHubLink(ActionEvent actionEvent) throws IOException{
        String URL = ("https://github.com/Shahriar-Ferdoush");
        Desktop.getDesktop().browse(URI.create(URL));
    }
}